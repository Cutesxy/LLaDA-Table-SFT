...
class DiffuGRPOConfig(TrainingArguments):
    ...
    num_generations_eval: Optional[int] = field(
        default=None,
        metadata={
            "help": "Compatibility field for newer TRL GRPOTrainer. If None, fallback to num_generations."
        },
    )
    ...
    steps_per_generation: int = field(
        default=1,
        metadata={
            "help": "Compatibility field for newer TRL GRPOTrainer. Keep 1 unless you explicitly need micro-steps for generation."
        },
    )
    max_tool_calling_iterations: Optional[int] = field(
        default=None,
        metadata={
            "help": "Compatibility field for newer TRL GRPOTrainer; keep None when not using tool-calling."
        },
    )
