...
# ==========================================
# 0. 参数解析 (与 LLaDA 保持参数名一致)
# ==========================================
def parse_args():
    parser = argparse.ArgumentParser(description="Llama-3.1-8B Baseline Table Evaluation")
    ...
    # Llama 的生成长度，由于 Llama 生成速度快，可以设为与 LLaDA 一致的 512
...
def main():
    ...
    if processed_count > 0:
        logger.info(f"\nFinal EM: {(total_em/processed_count)*100:.2f}% | Final F1: {(total_f1/processed_count)*100:.2f}%")
