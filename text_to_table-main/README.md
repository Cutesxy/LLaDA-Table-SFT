...
You can download the four datasets from [Google Drive](https://drive.google.com/file/d/1K0O5IwE7e90QUFGhafGqt-HWXR_unlRs/view?usp=sharing) or [Huggingface](https://huggingface.co/datasets/xqwu/text-to-table). If you are interested in preprocessing original table-to-text datasets into our text-to-table datasets, please check [data_preprocessing](data_preprocessing/).
